...
CreationTimestamp:      Tue, 29 Oct 2024 15:53:52 +0100
...
OldReplicaSets:  <none>
NewReplicaSet:   dev-backend-79bdf87454 (1/1 replicas created)
Events:
  Type    Reason             Age    From                   Message
  ----    ------             ----   ----                   -------
  Normal  ScalingReplicaSet  4m31s  deployment-controller  Scaled up replica set dev-backend-79bdf87454 to 1
```